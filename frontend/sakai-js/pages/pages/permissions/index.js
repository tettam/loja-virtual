...
import { PermissionService } from '../../../demo/service/PermissionService';
...
const Permission = () => {
    ...
    const objectService = new PermissionService();
    ...
    const deleteObject = () => {
        ...
        objectService.delete(object.id).then(data => {
            toast.current.show({ severity: 'success', summary: 'Successful', detail: 'Permissão deletada', life: 3000 });
            setObjects(null);
            setDeleteObjectDialog(false);
        })
    }
    ...
    const leftToolbarTemplate = () => {
        return (
            <React.Fragment>
                <div className="my-2">
                    <Button label="Criar permissão" icon="pi pi-plus" severity="sucess" className="mr-2" onClick={openNew} />                  
                </div>
            </React.Fragment>
        );
    };
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
            <h5 className="m-0">Gerenciar permissões</h5>
        ...
        <div className="grid crud-demo">
            <div className="col-12">
                <div className="card">
                    ...
                    <Dialog visible={objectDialog} style={{ width: '450px' }} header="Detalhes da permissão" modal className="p-fluid" footer={objectDialogFooter} onHide={hideDialog}>
                        <div className="field">
